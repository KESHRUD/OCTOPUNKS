...
public class ZoneMemoire extends JPanel
{
    ...
    public ZoneMemoire(Octopunks octopunks, Jeu jeu)
    {
        ...
        this.labelRobot1 = new JLabel("XR1 : " + jeu.robot1.getPositionX() + " - YR1 : " + jeu.robot1.getPositionY() + " - Salle "+jeu.robot1.getCurrentSalle().getId()+" - xG : "+jeu.robot1.getPosition().getXGraphique() + " et yG : "+jeu.robot1.getPosition().getYGraphique());
        ...
        this.labelRobot2 = new JLabel("XR2 : " + jeu.robot2.getPositionX() + " - YR2 : " + jeu.robot2.getPositionY() + " - Salle "+jeu.robot2.getCurrentSalle().getId()+" - xG : "+jeu.robot2.getPosition().getXGraphique() + " et yG : "+jeu.robot2.getPosition().getYGraphique());
    ...
    public void update()
    {
        this.labelRobot1.setText("XR1 : " + jeu.robot1.getPositionX() + " - YR1 : " + jeu.robot1.getPositionY() + " - Salle "+jeu.robot1.getCurrentSalle().getId()+" - xG : "+jeu.robot1.getRobotLabel().getX() + " et yG : "+jeu.robot1.getRobotLabel().getY());
        this.labelRobot2.setText("XR2 : " + jeu.robot2.getPositionX() + " - YR2 : " + jeu.robot2.getPositionY() + " - Salle "+jeu.robot2.getCurrentSalle().getId()+" - xG : "+jeu.robot2.getRobotLabel().getX() + " et yG : "+jeu.robot2.getRobotLabel().getY());
    }
}
